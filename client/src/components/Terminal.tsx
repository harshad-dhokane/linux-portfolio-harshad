    ...
    >
      ...
      >
        <div ref={terminalOutputRef}>
          {commandHistory.map((entry, index) => (
            <div key={index} className="mb-2">
              <div>
                <span className="text-green-400 font-mono">harshad@ubuntu:~/{currentPath.slice(1).join("/")}$</span> <span className="text-white">{entry.command}</span>
              </div>
        ...
        <div className="flex items-center mt-2">
          <span className="text-green-400 font-mono">harshad@ubuntu:~/{currentPath.slice(1).join("/")}$</span>
          <input
            ref={inputRef}
            type="text"
